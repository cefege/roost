// Byte-stability proof for the one POSIX shell quoter used by remote
// command construction across Roost. These tests pin both its exact escaping
// bytes and its semantic round trip through POSIX shells without
// interpretation.
