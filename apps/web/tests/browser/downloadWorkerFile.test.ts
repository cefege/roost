...
mock.module("../../src/client/rpc/connect.ts", () => ({ coordClient: { filesReadChunk } }));
...
const { downloadWorkerFileByHref, parseFileHref } = await import("../../src/browser/downloadWorkerFile.ts");
