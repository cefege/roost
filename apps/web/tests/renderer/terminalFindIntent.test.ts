...
import type { TerminalFind } from "../../src/renderer/terminalFindController.ts";
import type { TerminalFindQueryOptions } from "../../src/client/search/terminalFindHandoff.ts";
import {
