...
import { getPublicKeyB64 } from "../../client/auth/web-key.ts";
import {
  clearPairingCeremony,
  compactPairVerificationCode,
  loadPairingCeremony,
  savePairingCeremony,
} from "../../client/auth/pairing-ceremony.ts";
import type { PairingCeremony } from "../../client/auth/pairing-ceremony.ts";
import { isTransientPairingError } from "../../client/auth/pairing-transient-error.ts";
