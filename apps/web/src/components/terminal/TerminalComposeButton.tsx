...
import { createTerminalComposeSelection } from "../../renderer/terminalComposeSelection.ts";
import type { TerminalSelectionGuard } from "../../renderer/terminalComposeSelection.ts";
...
import { isCompact, isTouchDevice } from "../../browser/windowSizeClass.ts";
import { describeInputOutcome } from "../../client/input/terminalInputStatus.ts";
...
export type { TerminalSelectionGuard } from "../../renderer/terminalComposeSelection.ts";
