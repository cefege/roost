...
import { readLocalWorkerDoor, type LocalWorkerDoor } from "../../client/carriers/localWorkerDiscovery.ts";
import { terminalDirectRegistry, type TerminalDirectConnection, type TerminalDirectRegistry, type TerminalDirectRegistryEvent } from "../terminal-stream-transport.ts";
import { terminalGenerationTokenEquals } from "../terminal-stream-types.ts";
import { rootStore } from "../root.ts";
import { registerSyncV2ProbeResultHandler } from "../sync.ts";
...
import { activeTerminalPeerViewCount as activeViewCount, beginTerminalPeerHeartbeatEpisode, hasTerminalPeerDemand as hasDemand, recordTerminalPeerViewDemand as recordViewDemand, terminalPeerDeadline as deadline, terminalPeerNow as now, terminalPeerPageHidden as pageHidden } from "../../client/carriers/terminal-peer-runtime.ts";
