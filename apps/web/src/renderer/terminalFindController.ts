...
import type { FindMatch } from "../client/search/terminalFindPaging.ts";
import {
  runTerminalFindPageChain,
  type OlderMatchPage,
} from "../client/search/terminalFindPageChain.ts";
import {
  preferredTerminalFindIndex,
  type TerminalFindPreferredMatch,
  type TerminalFindQueryOptions,
} from "../client/search/terminalFindHandoff.ts";
import type { ScrollbackBackfill } from "./scrollbackBackfill.ts";

export type { FindMatch } from "../client/search/terminalFindPaging.ts";
