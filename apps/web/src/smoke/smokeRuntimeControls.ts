...
import { phaseTimeline as phaseTimelineImpl } from "../browser/diag.ts";
import { leakSample, perfCounters, resetPerfCounters as resetPerfCountersImpl } from "../browser/leakWatch.ts";
import { setForceHidden, setForceVisible } from "../browser/pageVisible.ts";
import { scrollbackBackfillRequestCount as scrollbackBackfillRequestCountImpl } from "../renderer/scrollbackBackfill.ts";
