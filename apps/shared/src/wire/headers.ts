...
// and sentinels are part of the auth-classification contract (a caller's own
// device credential vs a trusted proxy asserting the caller's address); a
// rename on one side silently reclassifies the other. Keep both ends
// importing from here.
...
export const AUTH_LAYER_TRUSTED_PROXY = "trusted-proxy";
