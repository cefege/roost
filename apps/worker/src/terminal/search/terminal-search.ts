...
import type { SessionShellRecord } from "../../session/session-record.ts";
import { terminalControlSettled } from "../../session/session-control-lanes.ts";
import {
...
import { historyFloorReason } from "../../session/session-scrollback.ts";
