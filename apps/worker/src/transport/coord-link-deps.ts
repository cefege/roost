...
import { writeAgentPrompt } from "../agents/agent-prompt-control.ts";
import {
	COORD_CELL_SINK_ID,
	resumeCellSink,
	suspendCellSink,
...
import { handleAttachmentChunk } from "../attachments/attachment-upload.ts";
import { handleBrowserCommand } from "../browser-commands/browser-command-handler.ts";
import type { SessionManager } from "../session/session-manager.ts";
import type { AgentScreenDetector } from "../agents/detector.ts";
import type { AgentStatusRegistry } from "../agents/registry.ts";
...
import type { CoordLink, CoordLinkDeps } from "./coord-link.ts";
import type { LocalTerminalWiring } from "./coord-link-types.ts";
import type { SessionEventStore } from "./session-event-store.ts";
import { terminalPipelineSnapshot } from "../terminal/terminal-pipeline-snapshot.ts";
import {
	flushTerminalMetadata,
	replayTerminalMetadata,
	setTerminalMetadataNegotiated,
} from "../session/session-terminal-metadata.ts";
import { TERMINAL_VIEW_OWNER_CAPABILITY } from "./coord-link-constants.ts";
...
export type { LocalTerminalWiring } from "./coord-link-types.ts";
