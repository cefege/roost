...
import { answerQueries, QUERY_CARRY_MAX } from "../terminal/terminal-query-reply.ts";
...
import { _scanAgentOsc, _scanAltModeTransitions, _scanOsc7 } from "../terminal/terminal-stream-scan.ts";
