...
import type { SessionEventReservation } from "../transport/event-sink.ts";
...
import { ALT_ENTER_SEQS, _scanAltModeTransitions, initAgentOscState } from "../terminal/terminal-stream-scan.ts";
import { RESUME_STAGE_CAP_BYTES } from "./session-constants.ts";
import { drainCoreReplies } from "../terminal/terminal-query-reply.ts";
import { appendToRing, createSbRing, readRing } from "../session-scrollback-ring.ts";
import { skipOrphanSequencePrefix } from "../terminal/terminal-replay-align.ts";
...
} from "../terminal/terminal-core-capacity.ts";
