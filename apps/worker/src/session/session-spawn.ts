...
import type { TerminalCoreLease } from "../terminal/terminal-core-capacity.ts";
...
import { withAgentStatusEnvironment } from "../agents/environment.ts";
import { initAgentOscState } from "../terminal/terminal-stream-scan.ts";
