...
import type { CoordLinkRefs, LocalTerminalWiring } from "../transport/coord-link-deps.ts";
import { AttachmentGrantStore } from "../attachments/attachment-grants.ts";
import { AttachmentDirectSockets } from "../attachments/attachment-direct-socket.ts";
import { AttachmentPeerOwner } from "../attachments/attachment-peer-owner.ts";
import { LocalTerminalGrantStore } from "../local-door/local-terminal-grants.ts";
import {
	LocalTerminalSockets,
	type LocalTerminalSocketTestFaults,
} from "../local-door/local-terminal-socket.ts";
import { startLocalUiServer } from "../local-door/local-ui-server.ts";
import type { SessionManager } from "../session/session-manager.ts";
import { TerminalInputRouteOwner } from "../terminal/terminal-input-route-owner.ts";
import { TerminalInputWorkBudget } from "../terminal/terminal-input-work-budget.ts";
import { TerminalPeerOwner } from "../terminal/peer/terminal-peer-owner.ts";
import type { TerminalPeerTestFaultState } from "../terminal/peer/terminal-peer-test-faults.ts";
import { TerminalViewOwner } from "../terminal/view/terminal-view-owner.ts";
