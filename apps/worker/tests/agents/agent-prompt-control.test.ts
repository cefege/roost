...
import type { AgentProcessIdentity } from "../../src/agents/process-scan.ts";
import {
  AgentStatusRegistry,
...
} from "../../src/agents/agent-prompt-control.ts";
import { PROMPT_SUBMIT_DELAY_MS } from "../../src/agents/agent-prompt-submit.ts";
