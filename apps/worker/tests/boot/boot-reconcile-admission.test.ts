...
import type { CoordClient } from "../../src/transport/coord-client.ts";
import { SessionEventStoreFatalError } from "../../src/transport/event-sink.ts";
import { getMultiplexedPool } from "../../src/keeper/multiplexed-client.ts";
import {
	setupReconcile,
	type ReconcileAdmissionOutcome,
} from "../../src/boot/boot-reconcile.ts";
import { SessionManager } from "../../src/session/session-manager.ts";
import { TerminalCoreCapacityError } from "../../src/terminal/terminal-core-capacity.ts";
import {
	OPEN_SESSIONS,
	WORKER_FP,
	bootActivation,
