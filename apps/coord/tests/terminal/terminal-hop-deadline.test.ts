...
import { processInputControl } from "../../src/terminal/input/input-control.ts";
import type { TerminalViewerIdentity } from "../../src/terminal/input/terminal-control-lane.ts";
