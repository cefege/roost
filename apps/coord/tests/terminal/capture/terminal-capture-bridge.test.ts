...
import type { AccountDeviceCaller } from "../../../src/auth/auth-principal.ts";
import type { ConnectDeps } from "../../../src/rpc/router.ts";
import {
  createTerminalCaptureBridge,
  type TerminalCaptureBridge,
} from "../../../src/terminal/capture/terminal-capture.ts";
import {
  _resetTerminalCaptureLeases,
  _sweepTerminalCaptureRecordings,
} from "../../../src/terminal/capture/terminal-capture-lease.ts";
import {
...
import { requestTerminalCapture } from "../../../src/terminal/capture/terminal-capture-worker-call.ts";
