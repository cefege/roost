...
import { recordCoordinatorFrame } from "../../../src/terminal/capture/terminal-capture-recorder.ts";
...
import { EPOCH, SESSION as HUB_SESSION, STREAM } from "../screen/terminal-screen-hub-harness.ts";
