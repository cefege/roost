...
import { dispatchDirectAttachmentWorkerResult } from "../../attachments/worker-frame-dispatch-direct-attachment.ts";
import { dispatchDirectTerminalWorkerResult } from "./worker-frame-dispatch-direct-terminal.ts";
import type { WorkerServiceDeps } from "../../workers/worker-conn-types.ts";
