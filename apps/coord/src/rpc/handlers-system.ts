...
import { getMetricsSnapshot } from "../diagnostics/telemetry.ts";
import {
  coordSessionDiagnostic,
  type CoordSessionDiagnostic,
} from "../diagnostics/diag-snapshot-session-state.ts";
import { connectWorkers } from "../workers/worker-registry.ts";
import type { ConnectDeps } from "./router.ts";
import { createScopedWorkerDiagnosticCollector } from "../diagnostics/diag-snapshot-worker-results.ts";
import { createTerminalCaptureBridge } from "../terminal/capture/terminal-capture.ts";
