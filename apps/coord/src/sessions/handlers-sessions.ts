...
import { appendEvent } from "../events/event-log.ts";
import { workspaceBus } from "../events/buses.ts";
import { publishPresence } from "../sync/presence-hub.ts";
import {
  callerKey,
...
import { getWorkerHubSocket } from "../workers/worker-service.ts";
import { sendBrowserCmd, forwardToSessionWorker, requireSessionWorkerSocket } from "../rpc/router-helpers.ts";
import type { ConnectDeps } from "../rpc/router.ts";
import { makeSessionScrollbackHandlers } from "../terminal/screen/handlers-sessions-scrollback.ts";
import { makeSessionLocalTerminalGrantHandlers } from "../terminal/direct/local-terminal-grants.ts";
import { makeSessionTerminalPeerHandlers } from "../terminal/direct/handlers-sessions-terminal-peer.ts";
import { makeSessionGlobalSearchHandlers } from "../search/handlers-sessions-global-search.ts";
import { GlobalSearchCursorOwner } from "../search/global-search-cursors.ts";
import { GlobalSearchWorkerLaneOwner } from "../search/global-search-worker-lanes.ts";
import { handleSessionsSpawn } from "./handler-session-spawn.ts";
import { bindSyncSessionSnapshot } from "../sync/sync-snapshot-registry.ts";
import {
  nextCompatibilityInputSeq,
  processInputControl,
  terminalViewerIdentity,
} from "../terminal/input/session-control.ts";
