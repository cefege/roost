...
use terminal_view_support::{
    FINGERPRINT, Harness, OTHER_FINGERPRINT, OTHER_SESSION, Recorded, SESSION, VIEW, decisions,
    watching,
};
...
/// The second view id, aliased so this file's intent reads at the call site.
const OTHER_VIEW_ID: &str = OTHER_VIEW;
...
fn a_closed_session_tells_its_sockets_to_stop_watching() {
    ...
    harness.view(&first, VIEW, 100, 40, 1, true, T0);
    harness.view(&second, OTHER_VIEW_ID, 120, 50, 1, true, T0);
    assert_eq!(
