// The terminal-core conformance cases: the byte sequences and the state each
// one must produce.
//
// Split out of the generator because they are DATA, not logic, and a file that
// is mostly a 300-line array of expectations is a file nobody can review. Each
// case names the oracle that produced its expectation, because a case whose
// answer came from one source is one source's opinion rather than a cross-check.
//
// The contract is protocol/conformance/README.md.
