<!-- AUDIENCE: claude -->
# docs/archive — completed historical records

These are **finished** roadmap, phase, and migration documents kept for provenance.
They describe work that has **shipped or been superseded** — they are NOT current
